...
maxPlayers = 200
motd = "Bienvenido a Pokemon Master X!"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = false
allowClones = true
serverName = "PokeMasterX"
loginMessage = "Bienvenido a Pokemon Master X!"
