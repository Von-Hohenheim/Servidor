...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if (item.itemid == 1386 and item.actionid == 13000) then
		doTeleportThing(cid, {x = 1379, y = 177, z = 12}, true)
		return true
	end
	
	if (item.itemid == 1386 and item.actionid == 13001) then
		doTeleportThing(cid, {x = 647, y = 703, z = 7}, true)
		return true
	end
