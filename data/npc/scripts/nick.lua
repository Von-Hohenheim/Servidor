...
local auras = {"skull aura", "love aura","red aura", "blue aura", "green aura", "yellow aura", "white aura", "gray aura", "cyan aura", "purple aura", "orange aura"}
...
elseif (msgcontains(msg, "apelido") or msgcontains(msg, "Apelido")) and focus == cid and conv == 1 then
...
elseif msgcontains(msg, "aura") and focus == cid and conv == 1 then
     ...
     return true
	  ...
	  if getItemAttribute(pb, "premierAura") and getItemAttribute(pb, "premierAura") ~= "" then
        selfSay("Desculpe mais seu pokemon ja possui aura da premier ball!")
        focus = 0
	  return true
      end
     ...
     selfSay("Você pode escolher entre essas auras: skull aura, love aura, red aura, blue aura, green aura, yellow aura, white aura, gray aura, cyan aura, purple aura, orange aura. Qual você prefere?")
     conv = 9
...
elseif msgcontains(msg, "yes") and focus == cid and conv == 11 then        
	 ...
	 if pokeBallName == "premier" then
        selfSay("Seu pokemon já possui a premier aura, diga !aura para altera-la.")
        focus = 0
		return true
     end
