catchModes = {
	...
	[1] = {
		...
		items = {    
	--		{19221, 1}, -- catcher token    -- catcher token não ganha no fácil no pxg e achei melhor não por aqui tbm pq tem pokes de 25 balls de média, e os players reclamam é da falta de grana q nem compensa as balls q gastam daí dá 50 ub
