pokesClan = {
["Naturia"] = {chaves = 19864, pokesC = {"Venusaur","Tangela","Vileplume","Scyther","Tangrowth","Pinsir","Venomoth","Meganium","Ariados","Sceptile","Heracross","Scizor","Exeggutor","Tropius","Cradily","Forretress","Ludicolo","Shiftry","Ninjask","Breelom","Armaldo","Parasect","Victreebel","Bellossom","Jumpluff","Sunflora","Heracross","Beautifly","Dustox","Masquerain","Shedinja","Volbeat","Illumise","Roselia","Cacturne","Shiny Scyther","Shiny Pinsir","Shiny Venomoth","Shiny Venonat","Shiny Venusaur","Shiny Meganium","Shiny Tangela","Shiny Ariados","Shiny Vileplume","Shiny Beedrill","Shiny Butterfree","Shiny Oddish","Shiny Paras","Shiny Parasect"}},
["Volcanic"] = {chaves = 19859, pokesC = {"Charizard","Typhlosion","Magmar","Arcanine","Magcargo","Ninetales","Magmortar","Blaziken","Flareon","Torkoal","Houndoom","Rapidash","Camerupt","Shiny Magcargo","Shiny Arcanine","Shiny Magmar","Shiny Typhlosion","Shiny Charizard","Shiny Ninetales","Shiny Flareon","Shiny Growlithe"}},
["Seavell"] = {chaves = 19860, pokesC = {"Blastoise","Vaporeon","Gyarados","Tentacruel","Lanturn","Jynx","Feraligatr","Politoed","Swampert","Milotic","Giant Magikarp","Lapras","Mantine","Slowking","Walrein","Kingdra","Shiny Magikarp", "Slowbro","Omastar","Kabutops","Piloswine","Ludicolo","Crawdaunt","Glalie","Shiny Blastoise","Shiny Vaporeon","Shiny Gyarados","Shiny Kingler","Shiny Tentacruel","Shiny Lanturn","Shiny Jynx","Shiny Tentacool","Shiny Horsea","Shiny Feraligatr","Shiny Politoed","Shiny Giant Magikarp","Golduck","Poliwrath","Dewgong","Cloyster","Kingler","Seadra","Shiny Seadra","Seaking","Starmie","Qwilfish","Azumarill","Quagsire","Sneasel","Corsola","Delibird","Octillery","Sharpedo","Wailmer","Wailord","Whiscash","Huntail","Gorebyss","Relicanth","Luvdisc","Pelipper"}},
["Orebound"] = {chaves = 19866, pokesC = {"Shiny Sudowoodo", "Gligar","Golem","Rhydon","Pupitar","Marowak","Magcargo","Aerodactyl","Rhyperior","Tyranitar","Swampert","Steelix","Sudowoodo","Armaldo","Aggron","Cradily","Donphan","Kabutops","Omastar","Claydol","Flygon","Piloswine","Camerupt","Shiny Golem","Shiny Rhydon","Shiny Pupitar","Shiny Marowak","Shiny Cubone","Shiny Sandslash","Shiny Magcargo","Shiny Onix","Onix","Sandslash","Nidoqueen","Nidoking","Quagsire","Corsola","Lunatone","Solrock","Whiscash","Relicanth"}},
["Wingeon"] = {chaves = 19863, pokesC = {"Shiny Dragonite", "Gligar","Fearow","Pidgeot","Scyther","Gyarados","Dragonair","Charizard","Farfetch'd","Dodrio","Aerodactyl","Salamence","Altaria","Dragonite","Crobat","Kingdra","Skarmory","Mantine","Tropius","Swellow","Flygon","Ninjask","Xatu","Togetic","Pelipper","Noctowl","Shiny Gyarados","Shiny Scyther","Shiny Dragonair","Shiny Pidgeot","Shiny Charizard","Shiny Farfetch'd","Shiny Zubat","Shiny Golbat","Shiny Dratini","Shiny Dodrio","Shiny Crobat","Shiny Fearow","Shiny Xatu","Jumpluff","Murkrow","Delibird","Beautifly","Masquerain","Shelgon"}},
["Malefic"] = {chaves = 19865, pokesC = {"Shiny Tyranitar", "Crobat","Gengar","Absol","Venusaur","Tentacruel","Muk","Venomoth","Umbreon","Dusknoir","Sableye","Nidoking","Tyranitar","Misdreavus","Houndoom","Banette","Seviper","Shiftry","Crawdaunt","Qwilfish","Mightyena","Shiny Gengar","Shiny Tentacool","Shiny Tentacruel","Shiny Grimer","Shiny Muk","Shiny Umbreon","Shiny Venonat","Shiny Venomoth","Shiny Nidoking","Shiny Venusaur","Shiny Beedrill","Shiny Crobat","Shiny Golbat","Shiny Zubat","Shiny Oddish","Shiny Weezing","Murkrow","Sneasel","Shedinja","Sharpedo","Cacturne","Dusclops","Swalot","Weezing","Nidoqueen","Beedrill","Vileplume","Victreebel","Ariados","Dustox"}},
["Gardestrike"] = {chaves = 19862, pokesC = {"Hitmontop","Hitmonlee","Tauros","Machamp","Stantler","Slaking","Kangaskhan","Blaziken","Hitmonchan","Breelom","Noctowl","Snorlax","Ursaring","Hariyama","Heracross","Blissey","Smeargle 8","Pidgeot","Primeape","Farfetch'd","Zangoose","Exploud","Miltank","Porygon2","Kecleon","Girafarig","Swellow","Medicham","Smeargle 7","Smeargle 6","Smeargle 5","Smeargle 4","Smeargle 3","Smeargle 2","Smeargle 1","Shiny Tauros","Shiny Pidgeot","Shiny Stantler", "Shiny Farfetch'd", "Shiny Hitmonlee","Shiny Hitmonchan","Shiny Snorlax","Shiny Machamp","Shiny Hitmontop","Wigglytuff","Poliwrath","Persian","Lickitung","Chansey","Ditto","Porygon","Aipom","Granbull","Linoone","Vigoroth","Delcatty","Shiny Ditto","Dodrio","Furret","Togetic"}},
["Psycraft"] = {chaves = 19867, pokesC = {"Alakazam","Clefable","Wigglytuff","Kadabra","Mr. Mime","Jynx","Xatu","Espeon","Metagross","Gardevoir","Exeggutor","Slowking","Wobbuffet","Slowbro","Golduck","Kirlia","Claydol","Starmie","Grumpig","Medicham","Togetic","Metang","Girafarig","Mawile","Granbull","Hypno","Shiny Hypno","Shiny Alakazam","Shiny Mr. Mime","Shiny Jynx","Shiny Xatu","Shiny Espeon","Lunatone","Solrock","Chimecho", "Unown"}},
["Raibolt"] = {chaves = 19861, pokesC = {"Raichu","Ampharos","Electabuzz","Manectric","Ampharos","Lanturn","Magneton","Electivire","Raichu","Jolteon","Magnezone","Electrode","Luxray","Flaaffy","Plusle","Minun","Pikachu","Shiny Electabuzz","Shiny Raichu","Shiny Ampharos","Shiny Lanturn","Shiny Magneton","Shiny Jolteon","Shiny Electrode", "Shiny Voltorb"}},
["Ironhard"] = {chaves = 19858, pokesC = {"Shiny Skarmory", "Shiny Steelix", "Scizor","Steelix","Aggron","Lucario","Magneton","Metagross","Skamory","Empoleon","Magnezone","Forretress","Lairon","Mawile","Metang","Shiny Onix","Shiny Magneton","Shiny Lucario"}}
}
...
local expC = {
    [1] = {min = 0, max = 20, chance = 75}, 
    [2] = {min = 21, max = 30, chance = 70}, 
    [3] = {min = 31, max = 35, chance = 65}, 
    [4] = {min = 36, max = 40, chance = 50}, 
    [5] = {min = 41, max = 45, chance = 40}, 
    [6] = {min = 46, max = 50, chance = 30}, 
    [7] = {min = 51, max = 55, chance = 25},
    [8] = {min = 56, max = 60, chance = 20}, 
    [9] = {min = 61, max = 65, chance = 15}, 
    [10] = {min = 66, max = 70, chance = 13},
    [11] = {min = 71, max = 75, chance = 10},
    [12] = {min = 76, max = 80, chance = 6},
    [13] = {min = 81, max = 85, chance = 4},
    [14] = {min = 86, max = 90, chance = 3},
    [15] = {min = 91, max = 99, chance = 2},
}
